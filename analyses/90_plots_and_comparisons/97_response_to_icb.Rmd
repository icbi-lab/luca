...
```{r}
summary(glm(as.formula("response_to_any ~ dataset + type + gender + sig_tan * study_arm + gender"), data=ici_clin_and_scores |> filter(!is.na(response_to_any)), family="binomial"))
```
```{r}
