...
luad_lusc_interactions |> mutate(group = if_else(log2_fc < 0, "LUSC", "LUAD")) |> ungroup() |> filter(fraction_expressed>0.1) |> filter(cluster_2 %in% immune_cells) |>cpdb_plot(edge_color="log2_fc") 
```
