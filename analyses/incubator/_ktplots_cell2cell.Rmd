...
```{r, include=FALSE}
cpdb_res_luad_lusc = read_csv("/home/sturm/Downloads/cpdb_luad_lusc.csv")
cpdb_res_luad_lusc_coarse = read_csv("/home/sturm/Downloads/cpdb_luad_lusc_coarse.csv")
```
...
top_genes = luad_lusc_interactions_coarse |> select(source, fdr) |> distinct() |> arrange(fdr) |> pull(source) |> head(15)
```
