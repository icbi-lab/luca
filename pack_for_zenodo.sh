...
# tar cvf - --dereference data/13_tcga/for_scissor data/12_input_adatas data/11_own_datasets/{batch1_3patients,batch2,velocyto} | xz -T 32 -9 > data/zenodo/input_data.tar.xz
